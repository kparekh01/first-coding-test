...
def is_power_of_two?(num)
  (0..num).any?{|number| 2 ** number == num}
=begin IMPLEENTED THROUGH WHILE LOOP!
  i = 0
  while i < num
    return true if 2**i == num # must return if it is inside the while loop
    i += 1
  end
  false #no need to return as it is the last statement
=end
end
